    ...
    (function ($) {
        ...
        loadYoumax = function() {
            ...
            $('#youmax').append('<div id="youmax-tabs"><!--<span id="featured_" class="youmax-tab">Featured</span>--><span id="uploads_" class="youmax-tab">Latest Videos</span><!--<span id="playlists_" class="youmax-tab">Playlists</span></div>-->');
    
    
            $('#youmax').append('<div id="youmax-encloser"><iframe id="youmax-video" width="'+(youmaxWidgetWidth-2)+'" height="'+(youmaxWidgetWidth/youmax_global_options.youtubeVideoAspectRatio)+'" src="" frameborder="0" allowfullscreen></iframe><div id="youmax-video-list-div"></div><div id="youmax-load-more-div">VER M\u00c1S VIDEOS</div></div>');
    
            $('#youmax-video').hide();
    
            //$('#youmax-lightbox').append('<button id="exit-button">↙️</button>')

            $('#youmax').append('<div id="youmax-lightbox"><div><iframe id="youmax-video-lightbox" src="" allowfullscreen></iframe></div></div>');
        ...
        resetLoadMoreButton = function() {
            ...
            $youmaxLoadMoreDiv.text('Load More Videos');
        },
